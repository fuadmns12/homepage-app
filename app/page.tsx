    ...
    <>
      ...
      >
        ...
        <div id="contentArea">
          ...
          {/* Event Section */}
          <div className={`content-section ${activeSection === 'event' ? 'active' : ''}`} id="event" style={{ display: activeSection === 'event' ? 'block' : 'none' }}>
            <GeuwatEvent backToMenu={backToMenu} isActive={activeSection === 'event'} />
          </div>

          {/* Ambassador Section */}
          <div className={`content-section ${activeSection === 'ambassador' ? 'active' : ''}`} id="ambassador" style={{ display: activeSection === 'ambassador' ? 'block' : 'none' }}>
